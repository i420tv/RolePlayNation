...
let speedo = mp.browsers.new("package://client/core/hud.html");
...
mp.events.add("render", () => {
    ...
    if (streetName && zoneName) {
        ...
        // }
        drawText(dayName, [minimap.rightX + 0.02, minimap.bottomY - 0.086], 4, [255, 255, 255, 200], 0.4);
        drawText('~y~' + streetName, [minimap.rightX + 0.02, minimap.bottomY - 0.065], 4, [255, 255, 255, 255], 0.4);
        drawText(zoneName, [minimap.rightX + 0.02, minimap.bottomY - 0.042], 4, [255, 255, 255, 255], 0.4);
    };

    // let vehicle = mp.player.vehicle;
});
