...
{/*
    class BurgerFlopper : Events.Script
    {
        ...
        {
            Events.Add("showBurgerFlopperOrders", ShowBurgerFlopperOrdersEvent);
        ...
        private void ShowBurgerFlopperOrdersEvent(object[] args)
        {
            ...
            Browser.CreateBrowserEvent(new object[] { "package://statics/html/sideMenu.html", "populateBurgerFlopperOrders", orders, distances });
        }
        ...
        private void DeliverFastfoodOrderEvent(object[] args)
        {
            ...
            Events.CallRemote("takeBurgerFlopperOrder", order);
        }
        ...
        private void OnPlayerEnterCheckpoint(Checkpoint checkpoint, Events.CancelEventArgs cancel)
        {
            ...
            {
                // Deliver the order
                Events.CallRemote("BurgerFlopperCheckpointReached");
            }
        }
    }*/
}
