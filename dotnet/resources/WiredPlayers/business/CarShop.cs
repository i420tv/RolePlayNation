...
namespace WiredPlayers.business
{
    public class CarShop : Script
    {
        ...
        public void OnResourceStart()
        {
            ...
            motorbikeShopTextLabel = NAPI.TextLabel.CreateTextLabel("/" + Commands.COM_CATALOG, new Vector3(2134.29f, 4782.58f, 40.97029f), 10.0f, 0.5f, 4, new Color(190, 235, 100));
            NAPI.TextLabel.CreateTextLabel(GenRes.catalog_help, new Vector3(2134.29f, 4782.58f, 40.87029f), 10.0f, 0.5f, 4, new Color(255, 255, 255));
            Blip motorbikeShopBlips = NAPI.Blip.CreateBlip(new Vector3(2134.29f, 4782.58f, 40.97029f));
            motorbikeShopBlips.Name = GenRes.motorcycle_dealer;
            motorbikeShopBlips.ShortRange = true;
            motorbikeShopBlips.Sprite = 226;

            amotorbikeShopTextLabel = NAPI.TextLabel.CreateTextLabel("/" + Commands.COM_CATALOG, new Vector3(-156.4598f, -1348.334f, 29.92242f), 10.0f, 0.5f, 4, new Color(190, 235, 100));
            NAPI.TextLabel.CreateTextLabel(GenRes.catalog_help, new Vector3(-156.4598f, -1348.334f, 29.82242f), 10.0f, 0.5f, 4, new Color(255, 255, 255));
            Blip motorbikeShopBlip = NAPI.Blip.CreateBlip(new Vector3(-156.4598f, -1348.334f, 29.92242f));
        ...
        public void TestVehicleEvent(Client player, string hash)
        {
            ...
            switch (GetClosestCarShop(player))
            {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    vehicle = NAPI.Vehicle.CreateVehicle(vehicleModel, new Vector3(-152.214f, -1360.359f, 29.67557f), 180.0f, new Color(0, 0, 0), new Color(0, 0, 0));
                    testFinishCheckpoint = new Vector3(-164.7418f, -1361.43f, 29.84067f);
                    break;
            }
