...
namespace WiredPlayers.globals
{
    public class Constants
    {
        ...
        public const int MAX_THEFTS_IN_ROW = 5;
        ...
        public const int STAFF_SENIOR_SUPPORT = 2;
        public const int STAFF_MODERATOR = 3;
        public const int STAFF_SENIOR_MODERATOR = 4;
        public const int STAFF_ADMIN = 5;
        public const int STAFF_SENIOR_ADMIN = 6;
        public const int STAFF_HEAD_ADMIN = 7;
        public const int STAFF_OWNER = 8;
        ...
        public const int BUSINESS_TYPE_BLACK_MARKET = 36;
        ...
        public const int VEHICLE_MOD_WINDOW_TINT = 69;
        ...
        public const int ITEM_TYPE_PLANTABLE = 6;

        // Amount of items when container opened
        public const int ITEM_OPEN_BEER_AMOUNT = 6;

        //Mining
     //   public const string ITEM_HASH_PICKAXE = "pickaxe";
        public const string ITEM_HASH_COPPER = "copperore";
        public const string ITEM_HASH_GOLD = "goldore";
        public const string ITEM_HASH_IRON = "ironore";
        public const string ITEM_HASH_LEAD = "leadore";
        public const string ITEM_HASH_TIN = "tinore";
        public const string ITEM_HASH_DIAMOND = "diamond";
        public const string ITEM_HASH_COPPERBAR = "copperbar";
        public const string ITEM_HASH_BRONZEBAR = "bronzebar";
        public const string ITEM_HASH_GOLDBAR = "goldbar";
        public const string ITEM_HASH_IRONBAR = "ironbar";
        public const string ITEM_HASH_TINBAR = "tinbar";
        public const string ITEM_HASH_LEADBAR = "leadbar";

        //DRUGS
        public const string ITEM_HASH_POT = "pot";
        public const string ITEM_HASH_WEED_SEEDS = "weed_seed";
        public const string ITEM_HASH_WEED = "weed";
        public const string ITEM_HASH_COCAIN = "cocain";
        public const string ITEM_HASH_METH = "meth";
        public const string ITEM_HASH_LEAF = "cocain_leafs";
        public const string ITEM_HASH_SODIUM = "sodium";
        public const string ITEM_HASH_ACETONE = "acetone";
        public const string ITEM_HASH_SULFURICACID = "sulfuric_acid";
        public const string ITEM_HASH_MAURETICACID = "mauretic_acid";
        public const string ITEM_HASH_EXTACY = "extacy";
        public const string ITEM_HASH_DUFFLEBAG = "dufflebag";
        public const string ITEM_HASH_HEMP = "hemp";
        ...
        public const string ITEM_HASH_PICKAXE = "54321";
        public const string ITEM_HASH_JACKHAMMER = "4321";
        ...
        //Furniture Items
        public const string ITEM_HASH_FURNITURE = "furniture";
        ...
        //meds
        public const string ITEM_HASH_BANDAGE = "bandage";
        public const string ITEM_HASH_MEDKIT = "medkit";


        // Miscelaneous items
        public const string ITEM_HASH_DRILL = "drill";
        public const string ITEM_HASH_HACKING_CHIP = "hackingchip";
        ...
        public const int PRICE_DRIVING_THEORICAL = 500;
        public const int PRICE_DRIVING_PRACTICAL = 1000;
        ...
        public const int PRICE_PACKAGES = 300;
        public const int PRICE_GAS = 5;
        public const int PRICE_FISH = 350;
        public const int PRICE_COPPER = 100;
        public const int PRICE_IRON = 150;
        public const int PRICE_GOLD = 300;
        public const int PRICE_DIAMOND = 500;
        public const int PRICE_COPPERBAR = 125;
        public const int PRICE_TINBAR = 190;
        public const int PRICE_LEADBAR = 250;
        public const int PRICE_BRONZEBAR = 350;
        public const int PRICE_IRONBAR = 175;
        public const int PRICE_GOLDBAR = 400;
        public const int PRICE_WEED = 50;
        public const int PRICE_WEEDGOOD = 60;
        public const int PRICE_WEEDGREAT = 76;
        public const int PRICE_WEEDPERFECT = 100;
        public const int PRICE_COCAIN = 500;
        public const int PRICE_COCAINGOOD = 510;
        public const int PRICE_COCAINGREAT = 600;
        public const int PRICE_COCAINPERFECT = 750;
        public const int PRICE_METH = 300;
        public const int PRICE_METHGOOD = 360;
        public const int PRICE_METHGREAT = 450;
        public const int PRICE_METHPERFECT = 500;
        ...
        public const int ILLEGAL_FACTION_ONE = 11;
        public const int ILLEGAL_FACTION_TWO = 12;
        public const int ILLEGAL_FACTION_THREE = 13;
        public const int ILLEGAL_FACTION_FOUR = 14;
        public const int ILLEGAL_FACTION_FIVE = 15;
        public const int ILLEGAL_FACTION_SIX = 16;
        public const int ILLEGAL_FACTION_SEVEN = 17;
        public const int ILLEGAL_FACTION_EIGHT = 18;
        public const int ILLEGAL_FACTION_NINE = 19;
        public const int ILLEGAL_FACTION_TEN = 20;
        public const int FACTION_DOC = 21;
        public const int LAST_STATE_FACTION = 99;
        ...
        public const int JOB_POSTALGQ = 12;
        ...
        public const int LICENSE_TRUCKER = 4;
        public const int LICENSE_PILOT = 5;
        ...
        public const int TRUCKER_DRIVING_PRACTICE = 6;
        public const int FLIGHT_PRACTICE = 7;
        ...
        {
            new InteriorModel(GenRes.townhall, new Vector3(-545.2846f,-203.8086f,38.21517f), new Vector3(-141.1987f, -620.913f, 168.8205f), "ex_dt1_02_office_02b", 498, GenRes.townhall),
            new InteriorModel(GenRes.hospital, new Vector3(355.4596f,-596.2038f,28.77325f), new Vector3(275.446f, -1361.11f, 24.5378f), "Coroner_Int_On", 153, GenRes.hospital),
          ...
          //  new InteriorModel(GenRes.driving_school, new Vector3(-227.6895f, 6333.742f, 32.41962f), new Vector3(-227.6895f, 6333.742f, 32.41962f), string.Empty, 269, GenRes.driving_school),
            new InteriorModel(GenRes.driving_school, new Vector3(-915.0544f, -2038.445f, 9.404984f), new Vector3(-915.0544f, -2038.445f, 9.404984f), string.Empty, 269, GenRes.driving_school),
        ...
        public static List<BusinessIplModel> BUSINESS_IPL_LIST = new List<BusinessIplModel>
        {
            ...
            new BusinessIplModel(BUSINESS_TYPE_WEED_WAREHOUSE, "bkr_biker_interior_placement_interior_3_biker_dlc_int_ware02_milo", new Vector3(1066.402f, -3183.405f, -39.16384f)),
        ...
        public static List<HouseIplModel> HOUSE_IPL_LIST = new List<HouseIplModel>
        {
            ...
            //big boy
            new HouseIplModel("Empty_Box_large", new Vector3(-518.3555f, 3464.49f, -61.47973f)),
            //small boy
            new HouseIplModel("Empty_box_small", new Vector3(-528.3021f, 3496.414f, -24.78074f)),

            //big boy
            new HouseIplModel("Empty_Motel_small", new Vector3(-559.8414f, 3631.144f, 10.13887f)),
            //small boy
            new HouseIplModel("Empty_Pemthouse", new Vector3(-490.8069f, 3647.718f, 10.312934f))
        ...
        public static List<FactionModel> FACTION_RANK_LIST = new List<FactionModel>
        {
            ...
            // LSC
            new FactionModel(JobRes.lsc_0_m, JobRes.lsc_0_f, FACTION_LSC, 0, 0),
            new FactionModel(JobRes.lsc_1_m, JobRes.lsc_1_f, FACTION_LSC, 2, 1388),
            new FactionModel(JobRes.lsc_3_m, JobRes.lsc_3_f, FACTION_LSC, 3, 1685),
            new FactionModel(JobRes.lsc_4_m, JobRes.lsc_4_f, FACTION_LSC, 4, 2056),
            new FactionModel(JobRes.lsc_5_m, JobRes.lsc_5_f, FACTION_LSC, 5, 2420),
            new FactionModel(JobRes.lsc_6_m, JobRes.lsc_6_f, FACTION_LSC, 6, 2901),

            // DOC
            new FactionModel(JobRes.doc_0_m, JobRes.doc_0_f, FACTION_DOC, 0, 0),
            new FactionModel(JobRes.doc_1_m, JobRes.doc_1_f, FACTION_DOC, 1, 1250),
            new FactionModel(JobRes.doc_2_m, JobRes.doc_2_f, FACTION_DOC, 2, 1388),
            new FactionModel(JobRes.doc_3_m, JobRes.doc_3_f, FACTION_DOC, 3, 1685),
            new FactionModel(JobRes.doc_4_m, JobRes.doc_4_f, FACTION_DOC, 4, 2056),
            new FactionModel(JobRes.doc_5_m, JobRes.doc_5_f, FACTION_DOC, 5, 2420),
            new FactionModel(JobRes.doc_6_m, JobRes.doc_6_f, FACTION_DOC, 6, 2901),
            new FactionModel(JobRes.doc_7_m, JobRes.doc_7_f, FACTION_DOC, 7, 2200),
            ...
            new FactionModel(JobRes.ems_10_m, JobRes.ems_10_f, FACTION_EMERGENCY, 10, 3500),
                        ...
                        // Illegal Factions
            new FactionModel(JobRes.rank1, JobRes.rank1, ILLEGAL_FACTION_ONE, 1, 0),
            new FactionModel(JobRes.rank2, JobRes.rank2, ILLEGAL_FACTION_ONE, 2, 0),
            new FactionModel(JobRes.rank3, JobRes.rank3, ILLEGAL_FACTION_ONE, 3, 0),
            new FactionModel(JobRes.rank4, JobRes.rank4, ILLEGAL_FACTION_ONE, 4, 0),
            new FactionModel(JobRes.rank5, JobRes.rank5, ILLEGAL_FACTION_ONE, 5, 0),
            new FactionModel(JobRes.rank6, JobRes.rank6, ILLEGAL_FACTION_ONE, 6, 0),
            new FactionModel(JobRes.rank7, JobRes.rank7, ILLEGAL_FACTION_ONE, 7, 0),
            new FactionModel(JobRes.rank8, JobRes.rank8, ILLEGAL_FACTION_ONE, 8, 0),
            new FactionModel(JobRes.rank9, JobRes.rank9, ILLEGAL_FACTION_ONE, 9, 0),
            new FactionModel(JobRes.rank10, JobRes.rank10, ILLEGAL_FACTION_ONE, 10, 0),
            new FactionModel(JobRes.rank1, JobRes.rank1, ILLEGAL_FACTION_TWO, 1, 0),
            new FactionModel(JobRes.rank2, JobRes.rank2, ILLEGAL_FACTION_TWO, 2, 0),
            new FactionModel(JobRes.rank3, JobRes.rank3, ILLEGAL_FACTION_TWO, 3, 0),
            new FactionModel(JobRes.rank4, JobRes.rank4, ILLEGAL_FACTION_TWO, 4, 0),
            new FactionModel(JobRes.rank5, JobRes.rank5, ILLEGAL_FACTION_TWO, 5, 0),
            new FactionModel(JobRes.rank6, JobRes.rank6, ILLEGAL_FACTION_TWO, 6, 0),
            new FactionModel(JobRes.rank7, JobRes.rank7, ILLEGAL_FACTION_TWO, 7, 0),
            new FactionModel(JobRes.rank8, JobRes.rank8, ILLEGAL_FACTION_TWO, 8, 0),
            new FactionModel(JobRes.rank9, JobRes.rank9, ILLEGAL_FACTION_TWO, 9, 0),
            new FactionModel(JobRes.rank10, JobRes.rank10, ILLEGAL_FACTION_TWO, 10, 0),
            new FactionModel(JobRes.rank1, JobRes.rank1, ILLEGAL_FACTION_THREE, 1, 0),
            new FactionModel(JobRes.rank2, JobRes.rank2, ILLEGAL_FACTION_THREE, 2, 0),
            new FactionModel(JobRes.rank3, JobRes.rank3, ILLEGAL_FACTION_THREE, 3, 0),
            new FactionModel(JobRes.rank4, JobRes.rank4, ILLEGAL_FACTION_THREE, 4, 0),
            new FactionModel(JobRes.rank5, JobRes.rank5, ILLEGAL_FACTION_THREE, 5, 0),
            new FactionModel(JobRes.rank6, JobRes.rank6, ILLEGAL_FACTION_THREE, 6, 0),
            new FactionModel(JobRes.rank7, JobRes.rank7, ILLEGAL_FACTION_THREE, 7, 0),
            new FactionModel(JobRes.rank8, JobRes.rank8, ILLEGAL_FACTION_THREE, 8, 0),
            new FactionModel(JobRes.rank9, JobRes.rank9, ILLEGAL_FACTION_THREE, 9, 0),
            new FactionModel(JobRes.rank10, JobRes.rank10, ILLEGAL_FACTION_THREE, 10, 0),
            new FactionModel(JobRes.rank1, JobRes.rank1, ILLEGAL_FACTION_FOUR, 1, 0),
            new FactionModel(JobRes.rank2, JobRes.rank2, ILLEGAL_FACTION_FOUR, 2, 0),
            new FactionModel(JobRes.rank3, JobRes.rank3, ILLEGAL_FACTION_FOUR, 3, 0),
            new FactionModel(JobRes.rank4, JobRes.rank4, ILLEGAL_FACTION_FOUR, 4, 0),
            new FactionModel(JobRes.rank5, JobRes.rank5, ILLEGAL_FACTION_FOUR, 5, 0),
            new FactionModel(JobRes.rank6, JobRes.rank6, ILLEGAL_FACTION_FOUR, 6, 0),
            new FactionModel(JobRes.rank7, JobRes.rank7, ILLEGAL_FACTION_FOUR, 7, 0),
            new FactionModel(JobRes.rank8, JobRes.rank8, ILLEGAL_FACTION_FOUR, 8, 0),
            new FactionModel(JobRes.rank9, JobRes.rank9, ILLEGAL_FACTION_FOUR, 9, 0),
            new FactionModel(JobRes.rank10, JobRes.rank10, ILLEGAL_FACTION_FOUR, 10, 0),
            new FactionModel(JobRes.rank1, JobRes.rank1, ILLEGAL_FACTION_FIVE, 1, 0),
            new FactionModel(JobRes.rank2, JobRes.rank2, ILLEGAL_FACTION_FIVE, 2, 0),
            new FactionModel(JobRes.rank3, JobRes.rank3, ILLEGAL_FACTION_FIVE, 3, 0),
            new FactionModel(JobRes.rank4, JobRes.rank4, ILLEGAL_FACTION_FIVE, 4, 0),
            new FactionModel(JobRes.rank5, JobRes.rank5, ILLEGAL_FACTION_FIVE, 5, 0),
            new FactionModel(JobRes.rank6, JobRes.rank6, ILLEGAL_FACTION_FIVE, 6, 0),
            new FactionModel(JobRes.rank7, JobRes.rank7, ILLEGAL_FACTION_FIVE, 7, 0),
            new FactionModel(JobRes.rank8, JobRes.rank8, ILLEGAL_FACTION_FIVE, 8, 0),
            new FactionModel(JobRes.rank9, JobRes.rank9, ILLEGAL_FACTION_FIVE, 9, 0),
            new FactionModel(JobRes.rank10, JobRes.rank10, ILLEGAL_FACTION_FIVE, 10, 0),
            new FactionModel(JobRes.rank1, JobRes.rank1, ILLEGAL_FACTION_SIX, 1, 0),
            new FactionModel(JobRes.rank2, JobRes.rank2, ILLEGAL_FACTION_SIX, 2, 0),
            new FactionModel(JobRes.rank3, JobRes.rank3, ILLEGAL_FACTION_SIX, 3, 0),
            new FactionModel(JobRes.rank4, JobRes.rank4, ILLEGAL_FACTION_SIX, 4, 0),
            new FactionModel(JobRes.rank5, JobRes.rank5, ILLEGAL_FACTION_SIX, 5, 0),
            new FactionModel(JobRes.rank6, JobRes.rank6, ILLEGAL_FACTION_SIX, 6, 0),
            new FactionModel(JobRes.rank7, JobRes.rank7, ILLEGAL_FACTION_SIX, 7, 0),
            new FactionModel(JobRes.rank8, JobRes.rank8, ILLEGAL_FACTION_SIX, 8, 0),
            new FactionModel(JobRes.rank9, JobRes.rank9, ILLEGAL_FACTION_SIX, 9, 0),
            new FactionModel(JobRes.rank10, JobRes.rank10, ILLEGAL_FACTION_SIX, 10, 0),
            new FactionModel(JobRes.rank1, JobRes.rank1, ILLEGAL_FACTION_SEVEN, 1, 0),
            new FactionModel(JobRes.rank2, JobRes.rank2, ILLEGAL_FACTION_SEVEN, 2, 0),
            new FactionModel(JobRes.rank3, JobRes.rank3, ILLEGAL_FACTION_SEVEN, 3, 0),
            new FactionModel(JobRes.rank4, JobRes.rank4, ILLEGAL_FACTION_SEVEN, 4, 0),
            new FactionModel(JobRes.rank5, JobRes.rank5, ILLEGAL_FACTION_SEVEN, 5, 0),
            new FactionModel(JobRes.rank6, JobRes.rank6, ILLEGAL_FACTION_SEVEN, 6, 0),
            new FactionModel(JobRes.rank7, JobRes.rank7, ILLEGAL_FACTION_SEVEN, 7, 0),
            new FactionModel(JobRes.rank8, JobRes.rank8, ILLEGAL_FACTION_SEVEN, 8, 0),
            new FactionModel(JobRes.rank9, JobRes.rank9, ILLEGAL_FACTION_SEVEN, 9, 0),
            new FactionModel(JobRes.rank10, JobRes.rank10, ILLEGAL_FACTION_SEVEN, 10, 0),
            new FactionModel(JobRes.rank1, JobRes.rank1, ILLEGAL_FACTION_EIGHT, 1, 0),
            new FactionModel(JobRes.rank2, JobRes.rank2, ILLEGAL_FACTION_EIGHT, 2, 0),
            new FactionModel(JobRes.rank3, JobRes.rank3, ILLEGAL_FACTION_EIGHT, 3, 0),
            new FactionModel(JobRes.rank4, JobRes.rank4, ILLEGAL_FACTION_EIGHT, 4, 0),
            new FactionModel(JobRes.rank5, JobRes.rank5, ILLEGAL_FACTION_EIGHT, 5, 0),
            new FactionModel(JobRes.rank6, JobRes.rank6, ILLEGAL_FACTION_EIGHT, 6, 0),
            new FactionModel(JobRes.rank7, JobRes.rank7, ILLEGAL_FACTION_EIGHT, 7, 0),
            new FactionModel(JobRes.rank8, JobRes.rank8, ILLEGAL_FACTION_EIGHT, 8, 0),
            new FactionModel(JobRes.rank9, JobRes.rank9, ILLEGAL_FACTION_EIGHT, 9, 0),
            new FactionModel(JobRes.rank10, JobRes.rank10, ILLEGAL_FACTION_EIGHT, 10, 0),
            new FactionModel(JobRes.rank1, JobRes.rank1, ILLEGAL_FACTION_NINE, 1, 0),
            new FactionModel(JobRes.rank2, JobRes.rank2, ILLEGAL_FACTION_NINE, 2, 0),
            new FactionModel(JobRes.rank3, JobRes.rank3, ILLEGAL_FACTION_NINE, 3, 0),
            new FactionModel(JobRes.rank4, JobRes.rank4, ILLEGAL_FACTION_NINE, 4, 0),
            new FactionModel(JobRes.rank5, JobRes.rank5, ILLEGAL_FACTION_NINE, 5, 0),
            new FactionModel(JobRes.rank6, JobRes.rank6, ILLEGAL_FACTION_NINE, 6, 0),
            new FactionModel(JobRes.rank7, JobRes.rank7, ILLEGAL_FACTION_NINE, 7, 0),
            new FactionModel(JobRes.rank8, JobRes.rank8, ILLEGAL_FACTION_NINE, 8, 0),
            new FactionModel(JobRes.rank9, JobRes.rank9, ILLEGAL_FACTION_NINE, 9, 0),
            new FactionModel(JobRes.rank10, JobRes.rank10, ILLEGAL_FACTION_NINE, 10, 0),
            new FactionModel(JobRes.rank1, JobRes.rank1, ILLEGAL_FACTION_TEN, 1, 0),
            new FactionModel(JobRes.rank2, JobRes.rank2, ILLEGAL_FACTION_TEN, 2, 0),
            new FactionModel(JobRes.rank3, JobRes.rank3, ILLEGAL_FACTION_TEN, 3, 0),
            new FactionModel(JobRes.rank4, JobRes.rank4, ILLEGAL_FACTION_TEN, 4, 0),
            new FactionModel(JobRes.rank5, JobRes.rank5, ILLEGAL_FACTION_TEN, 5, 0),
            new FactionModel(JobRes.rank6, JobRes.rank6, ILLEGAL_FACTION_TEN, 6, 0),
            new FactionModel(JobRes.rank7, JobRes.rank7, ILLEGAL_FACTION_TEN, 7, 0),
            new FactionModel(JobRes.rank8, JobRes.rank8, ILLEGAL_FACTION_TEN, 8, 0),
            new FactionModel(JobRes.rank9, JobRes.rank9, ILLEGAL_FACTION_TEN, 9, 0),
            new FactionModel(JobRes.rank10, JobRes.rank10, ILLEGAL_FACTION_TEN, 10, 0),
            // News
        ...
        {
            new JobModel(JobRes.unemployed_m, JobRes.unemployed_f, JOB_NONE, 0),
            new JobModel(JobRes.fastfood_m, JobRes.fastfood_f, JOB_FASTFOOD, 0),
            new JobModel(JobRes.thief_m, JobRes.thief_f, JOB_THIEF, 0),
            new JobModel(JobRes.mechanic_m, JobRes.mechanic_f, JOB_MECHANIC, 0),
            new JobModel(JobRes.gargage_m, JobRes.gargage_f, JOB_GARBAGE, 0),
            new JobModel(JobRes.hooker_m, JobRes.hooker_f, JOB_HOOKER, 0),
          //  new JobModel(JobRes.lawyer_m, JobRes.lawyer_f, JOB_LAWYER, 1000),
            new JobModel(JobRes.trucker_m, JobRes.trucker_f, JOB_TRUCKER, 0),
            new JobModel(JobRes.trucker_m, JobRes.trucker_f, JOB_POSTALGQ, 0)
        };
        ...
        public static Dictionary<int, List<string>> JOB_COMMANDS = new Dictionary<int, List<string>>
        {
          ...
          //  { JOB_THIEF, new List<string> { Commands.COM_FORCE, Commands.COM_STEAL, Commands.COM_HOTWIRE, Commands.COM_PAWN } },
           // { JOB_MECHANIC, new List<string> { Commands.COM_REPAIR, Commands.COM_REPAINT, Commands.COM_TUNING } },
        ...
        {  
            ...
            new UniformModel(0, FACTION_POLICE, SEX_FEMALE, 1, 53, 1),
            ...
            // Male DOC uniform
            new UniformModel(0, FACTION_DOC, SEX_MALE, 0, 0, 0),
            new UniformModel(0, FACTION_DOC, SEX_MALE, 1, 53, 1),
            new UniformModel(0, FACTION_DOC, SEX_MALE, 3, 97, 1),
            new UniformModel(0, FACTION_DOC, SEX_MALE, 4, 38, 1),
            new UniformModel(0, FACTION_DOC, SEX_MALE, 5, 49, 1),
            new UniformModel(0, FACTION_DOC, SEX_MALE, 6, 26, 1),
            new UniformModel(0, FACTION_DOC, SEX_MALE, 7, 111, 1),
            new UniformModel(0, FACTION_DOC, SEX_MALE, 8, 17, 1),
            new UniformModel(0, FACTION_DOC, SEX_MALE, 9, 12, 3),
            new UniformModel(0, FACTION_DOC, SEX_MALE, 10, 10, 1),
            new UniformModel(0, FACTION_DOC, SEX_MALE, 11, 54, 1),

            // Female DOC uniform
            new UniformModel(0, FACTION_DOC, SEX_FEMALE, 0, 0, 0),
            new UniformModel(0, FACTION_DOC, SEX_FEMALE, 1, 0, 0),
            new UniformModel(0, FACTION_DOC, SEX_FEMALE, 3, 14, 0),
            new UniformModel(0, FACTION_DOC, SEX_FEMALE, 4, 34, 0),
            new UniformModel(0, FACTION_DOC, SEX_FEMALE, 5, 0, 0),
            new UniformModel(0, FACTION_DOC, SEX_FEMALE, 6, 25, 0),
            new UniformModel(0, FACTION_DOC, SEX_FEMALE, 7, 0, 0),
            new UniformModel(0, FACTION_DOC, SEX_FEMALE, 8, 35, 0),
            new UniformModel(0, FACTION_DOC, SEX_FEMALE, 9, 0, 0),
            new UniformModel(0, FACTION_DOC, SEX_FEMALE, 10, 0, 0),
            new UniformModel(0, FACTION_DOC, SEX_FEMALE, 11, 48, 0),

                        // Male LSC uniform
            new UniformModel(0, FACTION_LSC, SEX_MALE, 0, 0, 0),
            new UniformModel(0, FACTION_LSC, SEX_MALE, 1, 0, 0),
            new UniformModel(0, FACTION_LSC, SEX_MALE, 3, 0, 0),
            new UniformModel(0, FACTION_LSC, SEX_MALE, 4, 0, 0),
            new UniformModel(0, FACTION_LSC, SEX_MALE, 5, 0, 0),
            new UniformModel(0, FACTION_LSC, SEX_MALE, 6, 12, 0),
            new UniformModel(0, FACTION_LSC, SEX_MALE, 7, 0, 0),
            new UniformModel(0, FACTION_LSC, SEX_MALE, 8, 58, 0),
            new UniformModel(0, FACTION_LSC, SEX_MALE, 9, 0, 0),
            new UniformModel(0, FACTION_LSC, SEX_MALE, 10, 0, 0),
            new UniformModel(0, FACTION_LSC, SEX_MALE, 11, 95, 0),

            // Female LSC uniform
            new UniformModel(0, FACTION_LSC, SEX_FEMALE, 0, 0, 0),
            new UniformModel(0, FACTION_LSC, SEX_FEMALE, 1, 0, 0),
            new UniformModel(0, FACTION_LSC, SEX_FEMALE, 3, 14, 0),
            new UniformModel(0, FACTION_LSC, SEX_FEMALE, 4, 27, 0),
            new UniformModel(0, FACTION_LSC, SEX_FEMALE, 5, 0, 0),
            new UniformModel(0, FACTION_LSC, SEX_FEMALE, 6, 24, 0),
            new UniformModel(0, FACTION_LSC, SEX_FEMALE, 7, 0, 0),
            new UniformModel(0, FACTION_LSC, SEX_FEMALE, 8, 35, 0),
            new UniformModel(0, FACTION_LSC, SEX_FEMALE, 9, 0, 0),
            new UniformModel(0, FACTION_LSC, SEX_FEMALE, 10, 0, 0),
            new UniformModel(0, FACTION_LSC, SEX_FEMALE, 11, 27, 0),
          ...
          //  new UniformModel(1, JOB_OCEANCLEANER, SEX_MALE, 1, 38, 0),
           ...
           // new UniformModel(1, JOB_OCEANCLEANER, SEX_FEMALE, 1, 38, 0),
            ...
            new UniformModel(1, JOB_OCEANCLEANER, SEX_FEMALE, 11, 53, 0)
        ...
        public static List<Vector3> Blackmarket = new List<Vector3>
        {
            // Cells
            new Vector3(-581.2188f, -1612.64f, 27.01082f),
            new Vector3(1364.366f, -2102.625f, 51.99857f),
            new Vector3(753.1875f, 1306.592f, 360.0679f),
        };
        // Jail positions
        ...
        // prison positions
        public static List<Vector3> PRISON_SPAWNS = new List<Vector3>
        {
            // Cells
           // new Vector3(460.0685f, -993.9847f, 24.91487f),
           // new Vector3(459.6115f, -998.0204f, 24.91487f),
        ...
        public static List<Vector3> LSC_POSITION = new List<Vector3>
        {

            // LSC POSITION
            new Vector3(-354.4169f, -128.2691f, 39.43061f),
        };
        ...
        {
            // 24-7
            new BusinessItemModel(ItemRes.beer_bottle, ITEM_HASH_BOTTLE_BEER_AM, ITEM_TYPE_CONSUMABLE, 10, 0.1f, 1, 0, 1, new Vector3(0.05f, -0.02f, -0.02f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_24_7, 0.08f),
            new BusinessItemModel(ItemRes.beer_pack, ITEM_HASH_PACK_BEER_AM, ITEM_TYPE_OPENABLE, 60, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_24_7, 0.0f),
            new BusinessItemModel(ItemRes.sandwich, ITEM_HASH_SANDWICH, ITEM_TYPE_CONSUMABLE, 5, 0.1f, 10, 0, 1, new Vector3(0.06f, 0.0f, -0.02f), new Vector3(180.0f, 180.0f, 90.0f), BUSINESS_TYPE_24_7, 0.0f),
            new BusinessItemModel(ItemRes.cigarettes, ITEM_HASH_CIGARRETES_PACK_OPEN, ITEM_TYPE_CONSUMABLE, 8, 0.1f, -5, 0, 1, new Vector3(0.06f, 0.0f, -0.02f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_24_7, 0.0f),
            new BusinessItemModel(ItemRes.cola, ITEM_HASH_CAN_COLA, ITEM_TYPE_CONSUMABLE, 5, 0.1f, 5, 0, 1, new Vector3(0.05f, -0.03f, 0.0f), new Vector3(270.0f, 20.0f, -20.0f), BUSINESS_TYPE_24_7, 0.0f),
            new BusinessItemModel(ItemRes.candy, ITEM_HASH_CANDY, ITEM_TYPE_CONSUMABLE, 4, 0.1f, 3, 0, 1, new Vector3(0.05f, -0.010f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_24_7, 0.0f),
            new BusinessItemModel(ItemRes.jerrycan, ITEM_HASH_JERRYCAN, ITEM_TYPE_EQUIPABLE, 25, 0.1f, 0, 0, 1, new Vector3(0.09f, 0.09f, 0.0f), new Vector3(0.0f, 90.0f, 175.0f), BUSINESS_TYPE_24_7, 0.0f),
            new BusinessItemModel(ItemRes.coffee, ITEM_HASH_CUP_COFFEE, ITEM_TYPE_CONSUMABLE, 10, 0.1f, 5, 0, 1, new Vector3(0.05f, -0.02f, -0.02f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_24_7, 0.0f),
            new BusinessItemModel(ItemRes.jackhammer, ITEM_HASH_JACKHAMMER, ITEM_TYPE_CONSUMABLE,  1000, 0.1f, 0, 0, 15, new Vector3(0.09f, 0.09f, 0.00f), new Vector3(0.0f, 90.0f, 175.0f), BUSINESS_TYPE_24_7, 0.0f),
            new BusinessItemModel(ItemRes.pickaxe, ITEM_HASH_PICKAXE, ITEM_TYPE_EQUIPABLE, 250, 0.1f, 0, 0, 1, new Vector3(0.09f, 0.09f, 0.00f), new Vector3(0.0f, 90.0f, 175.0f), BUSINESS_TYPE_24_7, 0.0f),
            new BusinessItemModel(ItemRes.medkit, ITEM_HASH_MEDKIT, ITEM_TYPE_CONSUMABLE, 500, 0.1f, 25, 0, 5, new Vector3(0.05f, -0.02f, -0.02f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_24_7, 0.0f),
            new BusinessItemModel(ItemRes.bandage, ITEM_HASH_BANDAGE, ITEM_TYPE_CONSUMABLE, 100, 0.1f, 10, 0, 10, new Vector3(0.05f, -0.02f, -0.02f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_24_7, 0.0f),


            // Oil station
            new BusinessItemModel(ItemRes.jerrycan, ITEM_HASH_JERRYCAN, ITEM_TYPE_EQUIPABLE, 25, 0.1f, 0, 0, 1, new Vector3(0.09f, 0.09f, 0.0f), new Vector3(0.0f, 90.0f, 175.0f), BUSINESS_TYPE_GAS_STATION, 0.0f),
 
            // Electronic store
            new BusinessItemModel(ItemRes.smartphone, ITEM_HASH_TELEPHONE, ITEM_TYPE_EQUIPABLE, 200, 0.1f, 0, 0, 1, new Vector3(0.06f, 0.0f, -0.02f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_ELECTRONICS, 0.0f),
            new BusinessItemModel(ItemRes.walkie, ITEM_HASH_WALKIE, ITEM_TYPE_EQUIPABLE, 150, 0.1f, 0, 0, 1, new Vector3(0.06f, 0.0f, -0.02f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_ELECTRONICS, 0.0f),
            new BusinessItemModel(ItemRes.camera, ITEM_HASH_CAMERA, ITEM_TYPE_EQUIPABLE, 50, 0.1f, 0, 0, 1, new Vector3(0.05f, -0.02f, -0.02f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_ELECTRONICS, 0.0f),
            new BusinessItemModel("Hacking Chip", ITEM_HASH_HACKING_CHIP, ITEM_TYPE_CONSUMABLE, 1500, 0.1f, 0, 0, 10, new Vector3(0.05f, -0.02f, -0.02f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_ELECTRONICS, 0.0f),

            // Hardware store
            new BusinessItemModel("Drill", ITEM_HASH_DRILL, ITEM_TYPE_MISC, 1000, 0.1f, 0, 0, 20, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_HARDWARE, 0.0f),
            new BusinessItemModel(ItemRes.crowbar, WeaponHash.Crowbar.ToString(), ITEM_TYPE_WEAPON, 60, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_HARDWARE, 0.0f),
            new BusinessItemModel(ItemRes.hammer, WeaponHash.Hammer.ToString(), ITEM_TYPE_WEAPON, 50, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_HARDWARE, 0.0f),
            new BusinessItemModel(ItemRes.flashlight, WeaponHash.Flashlight.ToString(), ITEM_TYPE_WEAPON, 30, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_HARDWARE, 0.0f),
            new BusinessItemModel(ItemRes.hatchet, WeaponHash.Hatchet.ToString(), ITEM_TYPE_WEAPON, 200, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_HARDWARE, 0.0f),
            new BusinessItemModel(ItemRes.wrench, WeaponHash.Wrench.ToString(), ITEM_TYPE_WEAPON, 100, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_HARDWARE, 0.0f),
            new BusinessItemModel(ItemRes.knucle_duster, WeaponHash.KnuckleDuster.ToString(), ITEM_TYPE_WEAPON, 100, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_HARDWARE, 0.0f),
            new BusinessItemModel(ItemRes.knife, WeaponHash.Knife.ToString(), ITEM_TYPE_WEAPON, 250, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_HARDWARE, 0.0f),
            new BusinessItemModel(ItemRes.switchblade, WeaponHash.SwitchBlade.ToString(), ITEM_TYPE_WEAPON, 150, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_HARDWARE, 0.0f),
            new BusinessItemModel(ItemRes.bat, WeaponHash.Bat.ToString(), ITEM_TYPE_WEAPON, 50, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_HARDWARE, 0.0f),
            new BusinessItemModel(ItemRes.pickaxe, ITEM_HASH_PICKAXE, ITEM_TYPE_EQUIPABLE, 250, 0.1f, 0, 0, 1, new Vector3(0.09f, 0.09f, 0.00f), new Vector3(0.0f, 90.0f, 175.0f), BUSINESS_TYPE_HARDWARE, 0.0f),
 
            // Bar
            new BusinessItemModel(ItemRes.beer_bottle, ITEM_HASH_BOTTLE_BEER_PISSWASSER, ITEM_TYPE_CONSUMABLE, 10, 0.1f, 1, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_BAR, 0.08f),
            new BusinessItemModel(ItemRes.burger, ITEM_HASH_BURGER, ITEM_TYPE_CONSUMABLE, 5, 0.1f, 20, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_BAR, 0.0f),
            new BusinessItemModel(ItemRes.coffee, ITEM_HASH_CUP_COFFEE, ITEM_TYPE_CONSUMABLE, 10, 0.1f, 5, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_BAR, 0.0f),
            new BusinessItemModel(ItemRes.cola, ITEM_HASH_CAN_COLA, ITEM_TYPE_CONSUMABLE, 5, 0.1f, 5, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_BAR, 0.0f),
            new BusinessItemModel(ItemRes.hotdog, ITEM_HASH_HOTDOG, ITEM_TYPE_CONSUMABLE, 2, 0.1f, 15, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_BAR, 0.0f),
 
            // Clubhouse
            new BusinessItemModel(ItemRes.beer_bottle, ITEM_HASH_BOTTLE_BEER_PISSWASSER, ITEM_TYPE_CONSUMABLE, 10, 0.1f, 1, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_CLUBHOUSE_THE_LOST, 0.08f),
            new BusinessItemModel(ItemRes.burger, ITEM_HASH_BURGER, ITEM_TYPE_CONSUMABLE, 5, 0.1f, 20, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_CLUBHOUSE_THE_LOST, 0.0f),
            new BusinessItemModel(ItemRes.coffee, ITEM_HASH_CUP_COFFEE, ITEM_TYPE_CONSUMABLE, 10, 0.1f, 5, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_CLUBHOUSE_THE_LOST, 0.0f),
            new BusinessItemModel(ItemRes.cola, ITEM_HASH_CAN_COLA, ITEM_TYPE_CONSUMABLE, 5, 0.1f, 5, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_CLUBHOUSE_THE_LOST, 0.0f),
            new BusinessItemModel(ItemRes.hotdog, ITEM_HASH_HOTDOG, ITEM_TYPE_CONSUMABLE, 2, 0.1f, 15, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_CLUBHOUSE_THE_LOST, 0.0f),
 
            // Disco
            new BusinessItemModel(ItemRes.beer_bottle, ITEM_HASH_BOTTLE_BEER_AM, ITEM_TYPE_CONSUMABLE, 10, 0.1f, 1, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_DISCO, 0.08f),
            new BusinessItemModel(ItemRes.juice, ITEM_HASH_CUP_JUICE, ITEM_TYPE_CONSUMABLE, 6, 0.1f, 10, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_DISCO, 0.0f),
            new BusinessItemModel(ItemRes.energy_drink, ITEM_HASH_ENERGY_DRINK, ITEM_TYPE_CONSUMABLE, 6, 0.1f, 5, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_DISCO, 0.0f),
            new BusinessItemModel(ItemRes.cava_bottle, ITEM_HASH_BOTTLE_CAVA, ITEM_TYPE_CONSUMABLE, 70, 0.1f, 15, 0, 5, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_DISCO, 0.05f),
 
            // Ammu-Nation
            new BusinessItemModel(ItemRes.pistol, WeaponHash.Pistol.ToString(), ITEM_TYPE_WEAPON, 2000, 0.1f, 0, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_AMMUNATION, 0.0f),
            new BusinessItemModel(ItemRes.pistol_ammo, ITEM_HASH_PISTOL_AMMO_CLIP, ITEM_TYPE_AMMUNITION, 300, 0.1f, 0, 0, STACK_PISTOL_CAPACITY, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_AMMUNATION, 0.0f),
            new BusinessItemModel(ItemRes.smg_ammo, ITEM_HASH_MACHINEGUN_AMMO_CLIP, ITEM_TYPE_AMMUNITION, 500, 0.1f, 0, 0, STACK_MACHINEGUN_CAPACITY, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_AMMUNATION, 0.0f),
            new BusinessItemModel(ItemRes.shotgun_ammo, ITEM_HASH_SHOTGUN_AMMO_CLIP, ITEM_TYPE_AMMUNITION, 400, 0.1f, 0, 0, STACK_SHOTGUN_CAPACITY, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_AMMUNATION, 0.0f),
            new BusinessItemModel(ItemRes.rifle_ammo, ITEM_HASH_ASSAULTRIFLE_AMMO_CLIP, ITEM_TYPE_AMMUNITION, 1000, 0.1f, 0, 0, STACK_ASSAULTRIFLE_CAPACITY, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_AMMUNATION, 0.0f),
            new BusinessItemModel(ItemRes.sniper_ammo, ITEM_HASH_SNIPERRIFLE_AMMO_CLIP, ITEM_TYPE_AMMUNITION, 2000, 0.1f, 0, 0, STACK_SNIPERRIFLE_CAPACITY, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_AMMUNATION, 0.0f),

            // Clothes store
            new BusinessItemModel(ItemRes.bat, WeaponHash.Bat.ToString(), ITEM_TYPE_WEAPON, 300, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_CLOTHES, 0.0f),
            new BusinessItemModel(ItemRes.golf_club, WeaponHash.GolfClub.ToString(), ITEM_TYPE_WEAPON, 250, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_CLOTHES, 0.0f),
 
            // Fishing store
            new BusinessItemModel(ItemRes.fishing_rod, ITEM_HASH_FISHING_ROD, ITEM_TYPE_EQUIPABLE, 250, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_FISHING, 0.0f),
            new BusinessItemModel(ItemRes.bait, ITEM_HASH_BAIT, ITEM_TYPE_MISC, 10, 0.1f, 0, 0, 10, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_FISHING, 0.0f),
 
            // Miscellaneous
            new BusinessItemModel(ItemRes.fish, ITEM_HASH_FISH, ITEM_TYPE_MISC, 0, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.copper, ITEM_HASH_COPPER, ITEM_TYPE_MISC, 0, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.iron, ITEM_HASH_IRON, ITEM_TYPE_MISC, 0, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.gold, ITEM_HASH_GOLD, ITEM_TYPE_MISC, 0, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.lead, ITEM_HASH_LEAD, ITEM_TYPE_MISC, 0, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.leaf, ITEM_HASH_LEAF, ITEM_TYPE_MISC, 0, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.tin, ITEM_HASH_TIN, ITEM_TYPE_MISC, 0, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.goldbar, ITEM_HASH_GOLDBAR, ITEM_TYPE_MISC, 0, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.leadbar, ITEM_HASH_LEADBAR, ITEM_TYPE_MISC, 0, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.tinbar, ITEM_HASH_TINBAR, ITEM_TYPE_MISC, 0, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.ironbar, ITEM_HASH_IRONBAR, ITEM_TYPE_MISC, 0, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.bronzebar, ITEM_HASH_BRONZEBAR, ITEM_TYPE_MISC, 0, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.copperbar, ITEM_HASH_COPPERBAR, ITEM_TYPE_MISC, 0, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.cocain, ITEM_HASH_COCAIN, ITEM_TYPE_CONSUMABLE, 0, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.sodium, ITEM_HASH_SODIUM, ITEM_TYPE_MISC, 150, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.acetone, ITEM_HASH_ACETONE, ITEM_TYPE_MISC, 20, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_BLACK_MARKET, 0.0f),
            new BusinessItemModel(ItemRes.hemp, ITEM_HASH_HEMP, ITEM_TYPE_MISC, 0, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.sufluricacid, ITEM_HASH_SULFURICACID, ITEM_TYPE_MISC, 135, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_BLACK_MARKET, 0.0f),
            new BusinessItemModel(ItemRes.extacy, ITEM_HASH_EXTACY, ITEM_TYPE_MISC, 0, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.maureticacid, ITEM_HASH_MAURETICACID, ITEM_TYPE_MISC, 100, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_BLACK_MARKET, 0.0f),
            new BusinessItemModel(ItemRes.dufflebag, ITEM_HASH_DUFFLEBAG, ITEM_TYPE_MISC, 0, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_24_7, 0.0f),

            new BusinessItemModel(ItemRes.weedpot, ITEM_HASH_POT, ITEM_TYPE_MISC, 10, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f),new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_24_7, 0.0f),
            new BusinessItemModel(ItemRes.weedseed, ITEM_HASH_WEED_SEEDS, ITEM_TYPE_PLANTABLE, 10, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f),new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_BLACK_MARKET, 0.0f),
            new BusinessItemModel(ItemRes.weed, ITEM_HASH_WEED, ITEM_TYPE_CONSUMABLE, 0, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f),new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.4f),
            new BusinessItemModel(ItemRes.products, ITEM_HASH_BUSINESS_PRODUCTS, ITEM_TYPE_MISC, 50, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.stolen_items, ITEM_HASH_STOLEN_OBJECTS, ITEM_TYPE_MISC, 50, 0.1f, 0, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.bullpup_shotgun, WeaponHash.BullpupShotgun.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.compact_rifle, WeaponHash.CompactRifle.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.carbine_rifle, WeaponHash.CarbineRifle.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.heavy_shotgun, WeaponHash.HeavyShotgun.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.sawn_off_shotgun, WeaponHash.SawnOffShotgun.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.bullpup_rifle, WeaponHash.BullpupRifle.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.assault_rifle, WeaponHash.AssaultRifle.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.ap_pistol, WeaponHash.APPistol.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.double_barrel_shotgun, WeaponHash.DoubleBarrelShotgun.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.machine_pistol, WeaponHash.MachinePistol.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.sniper_rifle, WeaponHash.SniperRifle.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.assault_smg, WeaponHash.AssaultSMG.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.combat_pdw, WeaponHash.CombatPDW.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.revolver, WeaponHash.Revolver.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.heavy_pistol, WeaponHash.HeavyPistol.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.pump_shotgun, WeaponHash.PumpShotgun.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.special_carbine, WeaponHash.SpecialCarbine.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.pistol_50, WeaponHash.Pistol50.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.advanced_rifle, WeaponHash.AdvancedRifle.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.heavy_sniper, WeaponHash.HeavySniper.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.micro_smg, WeaponHash.MicroSMG.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.assault_shotgun, WeaponHash.AssaultShotgun.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.marksman_rifle, WeaponHash.MarksmanRifle.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.smg, WeaponHash.SMG.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.pistol_ammo, ITEM_HASH_PISTOL_AMMO_CLIP, ITEM_TYPE_AMMUNITION, 0, 0.1f, 0, 0, STACK_PISTOL_CAPACITY, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.smg_ammo, ITEM_HASH_MACHINEGUN_AMMO_CLIP, ITEM_TYPE_AMMUNITION, 0, 0.1f, 0, 0, STACK_MACHINEGUN_CAPACITY, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.shotgun_ammo, ITEM_HASH_SHOTGUN_AMMO_CLIP, ITEM_TYPE_AMMUNITION, 0, 0.1f, 0, 0, STACK_SHOTGUN_CAPACITY, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.rifle_ammo, ITEM_HASH_ASSAULTRIFLE_AMMO_CLIP, ITEM_TYPE_AMMUNITION, 0, 0.1f, 0, 0, STACK_ASSAULTRIFLE_CAPACITY, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.sniper_ammo, ITEM_HASH_SNIPERRIFLE_AMMO_CLIP, ITEM_TYPE_AMMUNITION, 0, 0.1f, 0, 0, STACK_SNIPERRIFLE_CAPACITY, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f)
        };
...
{
            new Vector3(262.6624f, -1161.951f, 29.1885f),
            new Vector3(256.4384f, -1161.814f, 29.17914f),
            new Vector3(253.2458f, -1161.473f, 29.14883f),
        };
        ...
        public static List<Vector3> HACKABLE_TERMINALS = new List<Vector3>()
        {
            new Vector3(-2956.563f, 481.6994f, 15.69709f),
            new Vector3(-2956.854f, 483.4644f, 15.67529f),
            new Vector3(-105.4835f, 6471.919f, 31.62672f)
        };
        public static List<Vector3> BANKBOXES = new List<Vector3>()
        {
            new Vector3(-2958.502f, 484.0262f, 1567529f),
            new Vector3(-2957.343f, 485.9573f, 15.67533f),
            new Vector3(-2954.298f, 482.4786f, 15.6753f),
            new Vector3(-2954.02f, 486.2813f, 15.67541f),
            new Vector3(-2952.594f, 484.2762f, 15.67538f),
            new Vector3(-107.0286f, 6473.499f, 31.62672f),
            new Vector3(-107.6794f, 6475.671f, 31.62672f),
            new Vector3(-102.8615f, 6475.573f, 31.62674f),
            new Vector3(-103.2876f, 6478.302f, 31.62673f),
            new Vector3(-105.868f, 6478.51f, 31.62714f)
        };
        //DRUG DEALERS
        public static List<Vector3> DRUG_DEALERS = new List<Vector3>()
        {
            new Vector3(-581.2188f, -1612.64f, 27.01082f),
            new Vector3(1364.366f, -2102.625f, 51.99857f),
            new Vector3(1011.322f, -2866.011f, 39.15692f)
        };

        //Factory merchant
        public static List<Vector3> FACTORY_MERCHANT = new List<Vector3>()
        {
            new Vector3(1089.563f, -2001.63f, 30.87784f)
        };
        ...
        {
            // Island crates
            new CrateSpawnModel(1, new Vector3(-2153.035f, 5202.386f, 13.69618f)),
            new CrateSpawnModel(1, new Vector3(-2165.921f, 5196.308f, 15.8804f)),
            new CrateSpawnModel(1, new Vector3(-2166.648f, 5198.421f, 15.8804f)),
            new CrateSpawnModel(1, new Vector3(-2160.49f, 5205.409f, 15.59176f)),
            new CrateSpawnModel(1, new Vector3(-2170.187f, 5198.082f, 15.91406f)),
            new CrateSpawnModel(1, new Vector3(-2170.373f, 5195.084f, 15.88041f)),
            new CrateSpawnModel(1, new Vector3(-2164.61f, 5206.934f, 15.8803f)),
            new CrateSpawnModel(1, new Vector3(-2163.792f, 5195.11f, 15.37502f)),
            new CrateSpawnModel(1, new Vector3(-2160.487f, 5192.151f, 14.30191f)),
            new CrateSpawnModel(1, new Vector3(-2166.827f, 5207.111f, 15.92977f)),
            new CrateSpawnModel(1, new Vector3(-2168.576f, 5186.567f, 15.04852f)),
            new CrateSpawnModel(1, new Vector3(-2168.642f, 5204.536f, 15.94069f)),
            new CrateSpawnModel(1, new Vector3(-2171.918f, 5205.345f, 16.65958f)),
            new CrateSpawnModel(1, new Vector3(-2172.359f, 5194.064f, 15.8004f)),
            new CrateSpawnModel(1, new Vector3(-2183.144f, 5201.518f, 18.20478f)),
            new CrateSpawnModel(1, new Vector3(-2172.86f, 5196.362f, 15.86153f)),
            new CrateSpawnModel(1, new Vector3(-2187.248f, 5198.493f, 17.98749f)),
            new CrateSpawnModel(1, new Vector3(-2189.329f, 5208.591f, 18.73738f)),
            new CrateSpawnModel(1, new Vector3(-2175.566f, 5197.272f, 15.98747f)),
            new CrateSpawnModel(1, new Vector3(-2189.522f, 5223.072f, 20.30787f)),
            new CrateSpawnModel(1, new Vector3(-2185.964f, 5189.925f, 16.80379f)),
            new CrateSpawnModel(1, new Vector3(-2191.006f, 5229.609f, 20.79736f)),
            new CrateSpawnModel(1, new Vector3(-2196.236f, 5187.129f, 15.81522f)),
            new CrateSpawnModel(1, new Vector3(-2190.801f, 5234.782f, 20.2835f)),
            new CrateSpawnModel(1, new Vector3(-2194.725f, 5178.433f, 14.53511f)),
            new CrateSpawnModel(1, new Vector3(-2185.524f, 5230.828f, 20.47778f)),
            new CrateSpawnModel(1, new Vector3(-2185.441f, 5175.364f, 14.06973f)),
            new CrateSpawnModel(1, new Vector3(-2177.196f, 5228.695f, 18.0752f)),
            new CrateSpawnModel(1, new Vector3(-2175.935f, 5232.989f, 16.57436f)),
            new CrateSpawnModel(1, new Vector3(-2173.745f, 5171.083f, 13.5497f)),
            new CrateSpawnModel(1, new Vector3(-2167.835f, 5238.139f, 15.93195f)),
            new CrateSpawnModel(1, new Vector3(-2165.319f, 5241.51f, 16.14181f)),
            new CrateSpawnModel(1, new Vector3(-2163.495f, 5247.925f, 17.10531f)),
            new CrateSpawnModel(1, new Vector3(-2162.924f, 5251.871f, 17.53788f)),
            new CrateSpawnModel(1, new Vector3(-2169.315f, 5276.271f, 17.32012f)),
            new CrateSpawnModel(1, new Vector3(-2156.115f, 5246.802f, 17.67452f)),
            new CrateSpawnModel(1, new Vector3(-2149.593f, 5240.237f, 15.51855f)),
            new CrateSpawnModel(1, new Vector3(-2146.744f, 5237.425f, 13.9655f)),
            new CrateSpawnModel(1, new Vector3(-2142.169f, 5222.767f, 6.812176f)),
            new CrateSpawnModel(1, new Vector3(-2142.939f, 5209.612f, 9.51135f)),
            new CrateSpawnModel(1, new Vector3(-2156.537f, 5211.339f, 14.68363f)),
            new CrateSpawnModel(1, new Vector3(-2151.335f, 5163.203f, 10.25639f)),
            new CrateSpawnModel(1, new Vector3(-2151.14f, 5152.164f, 9.27355f)),
            new CrateSpawnModel(1, new Vector3(-2159.767f, 5197.274f, 15.10713f)),
            new CrateSpawnModel(1, new Vector3(-2171.098f, 5156.605f, 10.21814f)),
            new CrateSpawnModel(1, new Vector3(-2180.309f, 5144.453f, 2.673023f)),
            new CrateSpawnModel(1, new Vector3(-2194.942f, 5148.009f, 10.29645f)),
            new CrateSpawnModel(1, new Vector3(-2194.885f, 5160.1f, 11.14006f)),
            new CrateSpawnModel(1, new Vector3(-2207.712f, 5161.979f, 13.56075f)),
            new CrateSpawnModel(1, new Vector3(-2209.597f, 5178.93f, 15.06639f)),
            new CrateSpawnModel(1, new Vector3(-2190.155f, 5205.833f, 18.26774f)),
            new CrateSpawnModel(1, new Vector3(-2184.456f, 5200.89f, 18.14797f)),
            new CrateSpawnModel(1, new Vector3(-2208.291f, 5144.133f, 11.18868f)),
            new CrateSpawnModel(1, new Vector3(-2213.94f, 5124.733f, 10.61521f)),
            new CrateSpawnModel(1, new Vector3(-2219.709f, 5108.725f, 10.24075f)),
            new CrateSpawnModel(1, new Vector3(-2208.989f, 5095.347f, 8.770149f)),
            new CrateSpawnModel(1, new Vector3(-2194.331f, 5086.611f, 6.89854f)),
            new CrateSpawnModel(1, new Vector3(-2185.621f, 5108.169f, 7.753129f)),
            new CrateSpawnModel(1, new Vector3(-2192.36f, 5131.622f, 11.40428f)),
        ...
        public static List<WeaponProbabilityModel> WEAPON_CHANCE_LIST = new List<WeaponProbabilityModel>() {
            // Weapons
            new WeaponProbabilityModel(1, "BullpupShotgun", 0, 0, 60),
            ...
            new WeaponProbabilityModel(1, "SawnoffShotgun", 0, 126, 215),
            new WeaponProbabilityModel(1, "BullpupRifle", 0, 216, 235),
            new WeaponProbabilityModel(1, "AssaultRifle", 0, 236, 260),
            ...
            new WeaponProbabilityModel(1, "SMG", 0, 1196, 1235),
        ...
        {
            new JobPickModel(JOB_FASTFOOD, 605, GenRes.fastfood_job, new Vector3(177.1226f,-1437.733f, 29.24163f), DescRes.job_fastfood),
            new JobPickModel(JOB_HOOKER, 121, GenRes.hooker, new Vector3(105.7209f, -1302.901f, 28.7688f), DescRes.job_hooker),
         //   new JobPickModel(JOB_HOOKER, 121, GenRes.hooker, new Vector3(2467.066f, 4100.877f, 37.58295f), DescRes.job_hooker),
           // new JobPickModel(JOB_LAWYER, 351, GenRes.lawyer, new Vector3(-67.26025f, -802.2687f, 44.22607f), DescRes.job_lawyer),
            new JobPickModel(JOB_GARBAGE, 0, GenRes.garbage_job, new Vector3(-322.0652f, -1545.77f, 31.01992f), DescRes.job_garbage),
           // new JobPickModel(JOB_MECHANIC, 643, GenRes.mechanic_job, new Vector3(-354.4169f, -128.2691f, 39.43061f), DescRes.job_mechanic),
          //  new JobPickModel(JOB_MECHANIC, 643, GenRes.mechanic_job, new Vector3(-354.3326f, -128.1334f, 39.43064f), DescRes.job_mechanic),
            new JobPickModel(JOB_TRUCKER, 0, GenRes.trucker_job, new Vector3(-44.04705f, -2519.901f, 7.394626f), DescRes.job_trucker),
        ...
        {
            new Vector3(-919.114f, -2073.712f, 9.298992f),
            new Vector3(-943.1121f, -2120.947f, 8.887641f),
            new Vector3(-952.5896f, -2142.171f, 8.518621f),
            new Vector3(-1041.286f, -2068.246f, 12.85438f),
            new Vector3(-1036.365f, -1900.51f, 13.03217f),
            new Vector3(-795.5122f, -1648.201f, 15.54479f),
            new Vector3(-672.7524f, -1469.794f, 10.09965f),
            new Vector3(-634.6149f, -1320.676f, 10.23197f),
            new Vector3(-550.3497f, -1200.823f, 17.46019f),
            new Vector3(-473.5012f, -1427.936f, 28.77849f),
            new Vector3(-455.1696f, -1453.457f, 29.14608f),
            new Vector3(-472.0949f, -1612.04f, 38.76576f),
            new Vector3(-657.1853f, -1703.218f, 36.9991f),
            new Vector3(-737.3999f, -1711.001f, 28.84987f),
            new Vector3(-767.4808f, -1746.465f, 28.79453f),
            new Vector3(-745.5554f, -1859.974f, 26.75824f),
            new Vector3(-706.5836f, -2005.405f, 25.2541f),
            new Vector3(-755.1597f, -2159.815f, 14.18709f),
            new Vector3(-813.3907f, -2231.927f, 16.89049f),
            new Vector3(-952.6143f, -2408.738f, 13.38515f),
            new Vector3(-1080.202f, -2627.432f, 13.39196f),
            new Vector3(-908.759f, -2691.835f, 13.38054f),
            new Vector3(-811.1882f, -2549.451f, 13.286f),
            new Vector3(-690.382f, -2362.726f, 13.95193f),
            new Vector3(-506.8742f, -2149.623f, 8.56908f),
            new Vector3(-512.3411f, -2119.716f, 8.600118f),
            new Vector3(-684.6038f, -1945.499f, 6.549504f),
            new Vector3(-904.7913f, -2093.842f, 8.518836f),
            new Vector3(-942.5948f, -2121.374f, 8.897274f),
            new Vector3(-894.4449f, -2061.84f, 8.88063f)
        };
        ...
        public static List<Vector3> FISHING_POSITION_LIST = new List<Vector3>()
        {
            ...
            new Vector3(-1865.597f, -1237.609f, 8.615782f),
            new Vector3(-1246.973,-1882.666,0.5105467),
            new Vector3(-1247.876,-1860.286,1.172315),
            new Vector3(-1287.05,-1796.715,0.8054138),
            new Vector3(-1478.001,-1500.538,0.9291675),
            new Vector3(-1481.001,-1521.361,1.021886),
            new Vector3(-1510.988,-1446.059,0.7249604),
            new Vector3(-1505.574,-1452.949,0.6702966),
            new Vector3(-2893.958,-46.16898,1.661089),
            new Vector3(-3087.474,41.57643,1.321658),
            new Vector3(-3141.116,216.0407,1.592781),
            new Vector3(-3219.802,1392.42,1.065189),
            new Vector3(-3191.661,1424.919,1.88308),
            new Vector3(-1717.741,-1074.14,13.01735),
            new Vector3(-1805.081,-1178.298,13.01744),
            new Vector3(-1832.155,-1156.964,13.01728),
            new Vector3(-1878.879,-1213.965,13.01696),
            new Vector3(-1851.461,-1249.418,8.615791),
            new Vector3(-1805.79,-1242.418,13.01745),
            new Vector3(-1782.182,-1198.923,13.01728),
            new Vector3(-1735.838,-1123.101,13.01751),
            new Vector3(-1675.639,-1172.627,13.01735),
            new Vector3(-1643.969,-1134.875,13.01736),
            new Vector3(-3148.865,1460.399,4.307608),
            new Vector3(-3138.513,1465.955,0.69676),
            new Vector3(-3068.672,1506.116,0.9828895),
            new Vector3(-3067.532,1514.215,0.5632516),
            new Vector3(-3053.218,1520.512,1.986282),
            new Vector3(-3032.794,1554.063,2.467742),
            new Vector3(-3072.839,1605.423,0.4434754),
            new Vector3(-3091.218,1611.617,1.013619),
            new Vector3(-3174.493,1707.023,1.023389),
            new Vector3(-3151.755,1827.217,1.612341),
            new Vector3(-3083.704,1885.879,1.212085),
            new Vector3(-3048.389,1885.653,1.051957),
            new Vector3(-3075.991,1914.296,1.02185),
            new Vector3(-3029.959,2235.87,1.343174),
            new Vector3(-2868.394,2289.726,0.7983935),
            new Vector3(-2783.346,2290.609,1.297981),
            new Vector3(-2809.116,2368.028,1.169138),
            new Vector3(-2758.053,2555.482,0.9500111),
            new Vector3(-2687.18,2550.66,0.6378697),
            new Vector3(-2611.277,2537.78,0.6647698),
            new Vector3(-2496.042,2514.063,0.7685423),
            new Vector3(-2464.334,2451.568,0.8297768),
            new Vector3(-2301.575,2560.154,2.138031),
            new Vector3(-2087.809,2460.395,0.7631263),
            new Vector3(-1955.966,2511.113,0.8215283),
            new Vector3(-1857.753,2548.763,0.4599942),
            new Vector3(-1736.551,2559.112,0.1781264),
            new Vector3(-1363.086,2610.871,0.5972723),
            new Vector3(-1006.903,2820.355,7.946805),
            new Vector3(-1171.683,2722.725,1.298243),
            new Vector3(-850.6492,2788.547,10.47684),
            new Vector3(-377.0875,2996.222,16.19161),
            new Vector3(-224.3677,2975.92,19.11353),
            new Vector3(93.22329,3216.534,26.20094),
            new Vector3(147.744,3403.438,30.2779),
            new Vector3(220.0556,3607.776,31.09009),
            new Vector3(172.8789,3698.946,30.79162),
            new Vector3(263.2891,3646.806,30.43641),
            new Vector3(418.9629,3630.482,31.03938),
            new Vector3(506.9113,3637.09,30.57964),
            new Vector3(905.6707,3704.945,30.8963),
            new Vector3(2.429808,3787.278,30.71264),
            new Vector3(-121.5393,3701.622,30.3324),
            new Vector3(-211.5316,3859.562,30.79604),
            new Vector3(-160.9522,4171.167,31.05112),
            new Vector3(-259.2946,4295.143,35.46149),
            new Vector3(-647.6154,4410.852,15.64623),
            new Vector3(-883.234,4424.069,20.87911),
            new Vector3(-1601.38,4379.716,0.9302076),
            new Vector3(-1782.817,4883.794,1.319817),
            new Vector3(-1611.649,5263.015,3.974101),
            new Vector3(-1543.068,5170.202,1.564384),
            new Vector3(-1628.564,5437.545,11.97707),
            new Vector3(-1795.552,5511.023,11.09052),
            new Vector3(-2214.208,5013.978,4.973944),
            new Vector3(-2103.342,4851.507,5.056348),
            new Vector3(1412.374,4260.016,30.95387),
            new Vector3(1341.379,4225.018,33.91553),
            new Vector3(1296.03,4216.088,33.90865),
            new Vector3(1334.384,4269.102,31.50314),
            new Vector3(1255.886,4288.793,30.38857),
            new Vector3(860.3577,4420.454,30.94529),
            new Vector3(713.5281,4092.409,34.72787),
            new Vector3(404.0605,4327.481,30.65495),
            new Vector3(66.4516,4370.764,30.88973),
            new Vector3(33.21718,4406.813,30.89016),
            new Vector3(180.493,4238.189,30.96521),
            new Vector3(168.5939,3958.903,30.60229),
            new Vector3(198.776,3847.348,30.6767),
            new Vector3(1422.761,3852.057,31.87082),
            new Vector3(1477.168,3926.302,31.08842),
            new Vector3(1484.859,3949.073,31.49247),
            new Vector3(1732.664,3985.96,31.98203),
            new Vector3(1885.391,3998.887,31.881),
            new Vector3(2062.149,3893.768,30.82093),
            new Vector3(2120.97,3811.404,30.50257),
            new Vector3(2363.014,4091.934,30.42076),
            new Vector3(1846.075,4570.683,30.55751),
            new Vector3(1932.737,4517.031,31.03333),
            new Vector3(2274.87,4648.672,31.00614),
            new Vector3(2363.014,4091.934,30.42076),
            new Vector3(2420.438,4606.352,34.95478),
            new Vector3(847.7012,5863.087,0.526911),
            new Vector3(1005.567,6274.847,1.260649),
            new Vector3(798.1546,6018.931,1.002641),
            new Vector3(276.6841,6639.654,7.552221),
            new Vector3(53.88853,7260.582,0.7471296),
            new Vector3(485.0861,6773.235,0.284702),
            new Vector3(1586.253,6696.536,3.530253),
            new Vector3(2022.168,6778.005,2.136215),
            new Vector3(2580.957,6619.139,0.1841949),
            new Vector3(3398.227,5656.494,0.571331),
            new Vector3(3224.548,5319.993,0.7069622),
            new Vector3(3374.265,5183.389,1.46648),
            new Vector3(3438.048,5179.375,7.382133),
            new Vector3(3197.445,5095.798,1.408746),
            new Vector3(3583.057,5032.738,1.489637),
            new Vector3(3832.88,4801.959,3.736497),
            new Vector3(3900.21,4673.506,2.454389),
            new Vector3(4038.167,4488.006,0.7559249),
            new Vector3(3917.74,4351.131,3.08056),
            new Vector3(3867.736,4463.692,2.933285),
            new Vector3(3877.164,4236.829,1.01069),
            new Vector3(3758.075,3805.729,0.7135943),
            new Vector3(3960.592,3749.541,0.9827951),
            new Vector3(3758.683,3029.672,1.81764),
            new Vector3(3633.944,3118.963,1.441656),
            new Vector3(3558.487,2514.037,5.594316),
            new Vector3(3295.643,2194.555,1.007851),
            new Vector3(3329.142,2183.097,4.084475),
            new Vector3(3073.38,2221.426,1.357614),
            new Vector3(3061.415,1924.3,0.7399334),
            new Vector3(2872.169,1776.714,1.590369),
            new Vector3(3059.825,1570.056,1.099222),
            new Vector3(2928.836,1398.853,0.9405106),
            new Vector3(2788.287,1059.534,0.5951954),
            new Vector3(2918.406,807.6442,1.990403),
            new Vector3(2901.353,1002.742,2.611006),
            new Vector3(2989.338,888.2019,4.839974),
            new Vector3(3064.911,1136.393,3.239339),
            new Vector3(3036.274,613.3359,1.263952),
            new Vector3(2980.441,286.8041,0.8873246),
            new Vector3(2805.264,164.7144,0.5291145),
            new Vector3(2843.676,-688.5348,0.5501427),
            new Vector3(2672.496,-956.9527,0.8656539),
            new Vector3(2514.961,-1331.812,3.232263),
            new Vector3(2717.423,-1628.931,0.9200924),
            new Vector3(2334.669,-2137.687,0.7714626),
            new Vector3(1787.692,-2734.91,0.3953949),
            new Vector3(1550.734,-2816.692,1.152173),
            new Vector3(1274.653,-2747.144,0.308031),
            new Vector3(905.0417,-2638.34,3.260065),
            new Vector3(753.8613,-2690.069,6.52914),
            new Vector3(760.2516,-2903.734,1.041072),
            new Vector3(843.9007,-2899.188,6.117475),
            new Vector3(1136.415,-2898.725,6.291502),
            new Vector3(548.6877,-2431.413,2.134429),
            new Vector3(1250.7,-2880.998,9.319253),
            new Vector3(1230.395,-2880.981,9.319251),
            new Vector3(1228.725,-3023.701,9.329423),
            new Vector3(1252.624,-3022.141,9.319254),
            new Vector3(1254.15,-2949.375,9.319255),
            new Vector3(1253.271,-2899.541,9.319255),
            new Vector3(1299.028,-3064.682,6.304655),
            new Vector3(1173.144,-3349.592,5.901592),
            new Vector3(682.9276,-3185.001,6.608067),
            new Vector3(621.6083,-3031.448,6.264546),
            new Vector3(621.1088,-3205.765,6.069472),
            new Vector3(607.944,-3252.577,6.069562),
            new Vector3(592.083,-3299.219,6.069556),
            new Vector3(577.3561,-3210.647,5.465995),
            new Vector3(566.6046,-3128.989,6.06926),
            new Vector3(561.5173,-3210.498,5.465993),
            new Vector3(529.6577,-3163.636,4.17777),
            new Vector3(495.7229,-3390.286,6.070312),
            new Vector3(428.7416,-3205.476,5.208356),
            new Vector3(440.5845,-3021.792,6.269474),
            new Vector3(385.9539,-2737.603,6.396058),
            new Vector3(442.4621,-2626.651,6.098235),
            new Vector3(362.9243,-2834.975,1.303072),
            new Vector3(321.0901,-2241.125,5.769921),
            new Vector3(311.5585,-3209.049,5.809386),
            new Vector3(236.432,-3343.787,6.219544),
            new Vector3(200.0656,-2375.109,6.255487),
            new Vector3(104.7006,-3324.256,6.120468),
            new Vector3(105.5774,-3082.577,6.353796),
            new Vector3(121.4034,-2799.512,6.033129),
            new Vector3(186.344,-2701.345,6.392787),
            new Vector3(129.3923,-2706.892,6.45239),
            new Vector3(52.79516,-2383.429,5.999993),
            new Vector3(46.08469,-2794.581,5.723675),
            new Vector3(23.93748,-2808.674,5.701783),
            new Vector3(10.41376,-2801.854,2.525951),
            new Vector3(-8.030775,-2748.126,0.6650039),
            new Vector3(-19.03533,-2764.529,6.142548),
            new Vector3(-42.06227,-2778.12,1.829787),
            new Vector3(-46.96281,-2381.571,6.035505),
            new Vector3(-51.74145,-2774.593,6.063998),
            new Vector3(-69.13643,-2780.224,6.082122),
            new Vector3(-97.33327,-2762.325,6.08213),
            new Vector3(-140.3669,-2719.152,6.443985),
            new Vector3(-198.2099,-2698.592,6.427312),
            new Vector3(-250.7757,-2702.619,5.996597),
            new Vector3(-289.2565,-2769.133,2.195301),
            new Vector3(-279.1786,-2780.825,5.681273),
            new Vector3(-330.3458,-2798.143,4.994697),
            new Vector3(-472.9446,-2911.423,6.090864),
            new Vector3(-542.0899,-2787.143,6.132437),
            new Vector3(-514.9833,-2702.206,8.757849),
            new Vector3(-441.0939,-2624.108,8.761135),
            new Vector3(-468.2641,-2439.117,6.000784),
            new Vector3(-266.8684,-2529.204,6.378392),
            new Vector3(-348.8727,-2416.487,2.647468),
            new Vector3(-840.1293,-3127.151,0.8954495),
            new Vector3(-850.27,-3461.107,0.7216069),
            new Vector3(-989.1402,-3581.405,0.7844898),
            new Vector3(-1852.89,-3289.424,1.037499),
            new Vector3(-1861.303,-2736.255,1.549812),
            new Vector3(-1444.439,-2155.866,0.9171664),
            new Vector3(-1173.829,-1907.746,1.300706),
            new Vector3(-1281.417,-1927.131,0.7917427)
            
        };

        public static List<Vector3> LAB_POSITION_LIST = new List<Vector3>()
        {
            new Vector3(1345.57f, 4383.704f, 44.34375f),
            new Vector3(1034.568f, -3206.004f, -38.17668f)


        };
        public static List<Vector3> FACTORY_POSITION_LIST = new List<Vector3>()
        {
            new Vector3(1112.388f, -2005.329f, 35.4394f)
        ...
        public static List<Vector3> EQUIPMENT_DOC = new List<Vector3>()
        {
              new Vector3(1682.477f, 2574.275f, 45.91151f),
        };
        ...
        public static Dictionary<WeaponHash, string> WEAPON_ITEM_MODELS = new Dictionary<WeaponHash, string>()
        {
            ...
            { WeaponHash.HeavySniper, "w_sr_heavysniper" }, { WeaponHash.Knife, "w_me_knife" },
            { WeaponHash.KnuckleDuster, "w_me_knuckleduster" }, { WeaponHash.Machete, "w_me_machete" }, { WeaponHash.MachinePistol, "w_pi_machinepistol" },
            { WeaponHash.MarksmanPistol, "w_pi_marksmanpistol" }, { WeaponHash.MarksmanRifle, "w_sr_marksmanrifle" }, { WeaponHash.MicroSMG, "w_sb_microsmg" },
            { WeaponHash.MiniSMG, "w_sb_minismg" }, { WeaponHash.Musket, "w_ar_musket" },
            ...
            { WeaponHash.Pistol, "w_pi_pistol" }, { WeaponHash.Pistol50, "w_pi_pistol50" }, { WeaponHash.PoolCue, "w_me_poolcue" },
            { WeaponHash.PumpShotgun, "w_sg_pumpshotgun" }, { WeaponHash.Revolver, "w_pi_revolver" },
            { WeaponHash.SawnOffShotgun, "w_sg_sawnoffshotgun" }, { WeaponHash.SMG, "w_sb_smg" }, { WeaponHash.SmokeGrenade, "w_ex_smokegrenade" },
            { WeaponHash.SniperRifle, "w_sr_sniperrifle" }, { WeaponHash.Snowball, "w_am_snowball" }, { WeaponHash.SNSPistol, "w_pi_snspistol" },
            { WeaponHash.SpecialCarbine, "w_ar_specialcarbine" }, { WeaponHash.StunGun, "w_pi_stungun" },
