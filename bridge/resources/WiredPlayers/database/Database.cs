...
namespace WiredPlayers.database
{
    public class Database : Script
    {
        ...
        public void OnResourceStart()
        {
            ...
            // Tunning loading
            Lsc.tunningList = LoadAllTunning();
        ...
        public static int CreateCharacter(Client player, PlayerModel playerModel, SkinModel skin)
        {
            ...
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    command.Parameters.AddWithValue("@miningexp", playerModel.miningexp);
                    command.Parameters.AddWithValue("@mininglevel", playerModel.mininglevel);
                    command.Parameters.AddWithValue("@firstaidexp", playerModel.firstaidexp);
                    command.Parameters.AddWithValue("@firstaidlevel", playerModel.firstaidlevel);
                    command.Parameters.AddWithValue("@truckerexp", playerModel.truckingexp);
                    command.Parameters.AddWithValue("@truckerlevel", playerModel.truckinglevel);
                    command.Parameters.AddWithValue("@staminaexp", playerModel.staminaexp);
                    command.Parameters.AddWithValue("@staminalevel", playerModel.staminalevel);
                    command.Parameters.AddWithValue("@strenghtexp", playerModel.strenghtexp);
                    command.Parameters.AddWithValue("@strenghtlevel", playerModel.strenghtlevel);
                    command.Parameters.AddWithValue("@fishingexp", playerModel.fishingexp);
                    command.Parameters.AddWithValue("@fishinglevel", playerModel.fishinglevel);
                    command.Parameters.AddWithValue("@lockpickingexp", playerModel.lockpickingexp);
                    command.Parameters.AddWithValue("@lockpickinglevel", playerModel.lockpickinglevel);
                    command.Parameters.AddWithValue("@egnineerexp", playerModel.engineerexp);
                    command.Parameters.AddWithValue("@egnineerlevel", playerModel.engineerlevel);
        ...
        public static int CreateUnit(UnitModel UnitModel)
        {
            int id = 0;
            ...
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                ...
                command.CommandText = "INSERT INTO units (id, member, name, faction) ";
                command.CommandText += "VALUES (@id, @member, @name, @faction)";
                command.Parameters.AddWithValue("@id", UnitModel.id);
                command.Parameters.AddWithValue("@member", UnitModel.member);
                command.Parameters.AddWithValue("@name", UnitModel.name);
                command.Parameters.AddWithValue("@faction", UnitModel.faction);
        ...
        public static List<UnitModel> LoadUnits()
        {
            ...
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                ...
                using (MySqlDataReader reader = command.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        Unit.id = reader.GetInt32("id");
                        Unit.name = reader.GetString("name");
                        Unit.member = reader.GetString("member");
        ...
        public static List<SkillsModel> LoadSkills()
        {
            List<SkillsModel> SkillList = new List<SkillsModel>();
            ...
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                ...
                using (MySqlDataReader reader = command.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        SkillsModel PlayerSkill = new SkillsModel();

                        PlayerSkill.id = reader.GetInt32("id");
                        PlayerSkill.miningexp = reader.GetInt32("miningexp");
                        PlayerSkill.mininglevel = reader.GetInt32("mininglevel");
                        PlayerSkill.lockpickingexp = reader.GetInt32("lockpickingexp");
                        PlayerSkill.lockpickinglevel = reader.GetInt32("lockpickinglevel");
                        PlayerSkill.strenghtexp = reader.GetInt32("strenghtexp");
                        PlayerSkill.strenghtlevel = reader.GetInt32("strenghtlevel");
                        PlayerSkill.firstaidexp = reader.GetInt32("firstaidexp");
                        PlayerSkill.firstaidlevel = reader.GetInt32("firstaidlevel");
                        PlayerSkill.truckingexp = reader.GetInt32("truckerexp");
                        PlayerSkill.truckinglevel = reader.GetInt32("truckerlevel");
                        PlayerSkill.staminaexp = reader.GetInt32("staminaexp");
                        PlayerSkill.staminalevel = reader.GetInt32("staminalevel");
                        PlayerSkill.fishingexp = reader.GetInt32("fishingexp");
                        PlayerSkill.fishinglevel = reader.GetInt32("fishinglevel");
                        PlayerSkill.engineerexp = reader.GetInt32("engineerexp");
                        PlayerSkill.engineerlevel = reader.GetInt32("engineerlevel");
                        PlayerSkill.engineerlevel = reader.GetInt32("engineerlevel");
                        PlayerSkill.drugprodexp = reader.GetInt32("drugprodexp");
                        PlayerSkill.drugprodlevel = reader.GetInt32("drugprodlevel");
                        PlayerSkill.herbalismexp = reader.GetInt32("herbalismexp");
                        PlayerSkill.herbalismlevel = reader.GetInt32("herbalismlevel");
            ...
            public static void UpdateSkills(PlayerModel player)
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                try
                {
                    connection.Open();
                    MySqlCommand command = connection.CreateCommand();
                    command.CommandText = "UPDATE skills SET"; //  'lockpickingexp' = @lockpickingexp, 'lockpickinglevel' = @lockpickinglevel"; //'miningexp' = @miningexp, 'mininglevel' = @mininglevel, 'firstaidexp' = @firstaidexp, 'fishinglevel' = @fishinglevel, 'fishingexp' = @fishingexp " +
                //     "'firstaidlevel' = @firstaidlevel, 'truckerexp' = @truckerexp, 'truckerlevel' = @truckerlevel, 'staminaexp' = @staminaexp, 'staminalevel' = @staminalevel, 'Strenghtexp' = @strenghtexp, 'strenghtlevel' = @strenghtlevel" +
                //     "'engineerexp' = @engineerexp, 'engineerlevel' = @engineerlevel ";
                  /*
                     command.Parameters.AddWithValue("@miningexp", player.miningexp);
                    command.Parameters.AddWithValue("@mininglevel", player.mininglevel);
                    command.Parameters.AddWithValue("@firstaidexp", player.firstaidexp);
                    command.Parameters.AddWithValue("@firstaidlevel", player.firstaidlevel);
                    command.Parameters.AddWithValue("@truckerexp", player.truckingexp);
                    command.Parameters.AddWithValue("@truckerlevel", player.truckinglevel);
                    command.Parameters.AddWithValue("@staminaexp", player.staminaexp);
                    command.Parameters.AddWithValue("staminalevel", player.staminalevel);
                    command.Parameters.AddWithValue("@strenghtexp", player.strenghtexp);
                    command.Parameters.AddWithValue("@strenghtlevel", player.strenghtlevel);
                    command.Parameters.AddWithValue("@fishingexp", player.fishingexp);
                    command.Parameters.AddWithValue("@fishinglevel", player.fishinglevel);*/
                  //  command.Parameters.AddWithValue("@lockpickingexp", player.lockpickingexp);
                  //  command.Parameters.AddWithValue("@lockpickinglevel", player.lockpickinglevel);
                   // command.Parameters.AddWithValue("@egnineerexp", player.engineerexp);
                   // command.Parameters.AddWithValue("@egnineerlevel", player.engineerlevel);
        ...
        */
        ...
        public static void SaveSkills(List<SkillsModel> PlayerSkillList)
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    command.CommandText = "UPDATE skills SET miningexp = @miningexp, mininglevel = @mininglevel, lockpickinglevel = @lockpickinglevel, lockpickingexp = @lockpickingexp, firstaidexp = @firstaidexp, firstaidlevel = @firstaidlevel, strenghtexp = @strenghtexp, strenghtlevel = @strenghtlevel, truckerexp = @truckerexp, truckerlevel = @truckerlevel, fishingexp = @fishingexp, fishinglevel = @fishinglevel, engineerexp = @engineerexp, engineerlevel = @engineerlevel, drugprodexp = @drugprodexp, drugprodlevel = @drugprodlevel, herbalismexp = @herbalismexp, herbalismlevel = @herbalismlevel";
                  //  command.CommandText += "WHERE id = @id LIMIT 1";

                    foreach (SkillsModel skills in PlayerSkillList)
                    {

                        command.Parameters.AddWithValue("@miningexp", skills.miningexp);
                        command.Parameters.AddWithValue("@mininglevel", skills.mininglevel);
                        command.Parameters.AddWithValue("@firstaidexp", skills.firstaidexp);
                        command.Parameters.AddWithValue("@firstaidlevel", skills.firstaidlevel);
                        command.Parameters.AddWithValue("@truckerexp", skills.truckingexp);
                        command.Parameters.AddWithValue("@truckerlevel", skills.truckinglevel);
                        command.Parameters.AddWithValue("@staminaexp", skills.staminaexp);
                        command.Parameters.AddWithValue("staminalevel", skills.staminalevel);
                        command.Parameters.AddWithValue("@strenghtexp", skills.strenghtexp);
                        command.Parameters.AddWithValue("@strenghtlevel", skills.strenghtlevel);
                        command.Parameters.AddWithValue("@fishingexp", skills.fishingexp);
                        command.Parameters.AddWithValue("@fishinglevel", skills.fishinglevel);
                        command.Parameters.AddWithValue("@lockpickingexp", skills.lockpickingexp);
                        command.Parameters.AddWithValue("@lockpickinglevel", skills.lockpickinglevel);
                        command.Parameters.AddWithValue("@engineerexp", skills.engineerexp);
                        command.Parameters.AddWithValue("@engineerlevel", skills.engineerlevel);
                        command.Parameters.AddWithValue("@drugprodexp", skills.drugprodexp);
                        command.Parameters.AddWithValue("@drugprodlevel", skills.drugprodlevel);
                        command.Parameters.AddWithValue("@herbalismexp", skills.herbalismexp);
                        command.Parameters.AddWithValue("@herbalismlevel", skills.herbalismlevel);
                ...
                {
                    NAPI.Util.ConsoleOutput("[EXCEPTION SaveSkills] " + ex.Message);
                    NAPI.Util.ConsoleOutput("[EXCEPTION SaveSKills] " + ex.StackTrace);
                }
            }
        }
        ...
        public static int AddPlant(PlantModel plant)
        {
            int plantId = 0;
            ...
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    command.CommandText = "INSERT INTO `plants` (`posX`, `posY`, `posZ`, `dimension`, `growth`)";
                    command.CommandText += " VALUES (@posX, @posY, @posZ, @dimension, @growth)";
                    command.Parameters.AddWithValue("@dimension", plant.Dimension);
                    command.Parameters.AddWithValue("@growth", plant.GrowTime);
                    command.Parameters.AddWithValue("@posX", plant.Position.X);
                    command.Parameters.AddWithValue("@posY", plant.Position.Y);
                    command.Parameters.AddWithValue("@posZ", plant.Position.Z);

                    command.ExecuteNonQuery();
                    plantId = (int)command.LastInsertedId;
                }
                catch (Exception ex)
                {
                    NAPI.Util.ConsoleOutput("[EXCEPTION Addplant] " + ex.Message);
                    NAPI.Util.ConsoleOutput("[EXCEPTION Addplant] " + ex.StackTrace);
                }
            }

            return plantId;
        }
        public static List<PlantModel> LoadAllPlants()
        {
            ...
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                    connection.Open();
                    MySqlCommand command = connection.CreateCommand();
                    command.CommandText = "SELECT * FROM plants";
                    ...
                    using (MySqlDataReader reader = command.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            ...
                            plant.Dimension = Convert.ToUInt32(reader.GetInt32(reader.GetOrdinal("dimension")));
                            plant.GrowTime = reader.GetInt32(reader.GetOrdinal("growth"));
                            plant.Position = new Vector3(posX, posY, posZ);
        ...
        public static void ModifyPlant(PlantModel plant)
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    command.CommandText = "UPDATE `plants` SET `growth` = @growth, `id` = @id ";
                    command.Parameters.AddWithValue("@growth", plant.GrowTime);
                    command.Parameters.AddWithValue("@ownerIdentifier", plant.Id);
                    command.ExecuteNonQuery();
                }
                catch (Exception ex)
                {
                    NAPI.Util.ConsoleOutput("[EXCEPTION UpdatePlant] " + ex.Message);
                    NAPI.Util.ConsoleOutput("[EXCEPTION UpdatePlant] " + ex.StackTrace);
                }
            }
            ...
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                ...
                using (MySqlDataReader reader = command.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        item.quality = reader.GetString("quality");
        ...
        public static int AddNewItem(ItemModel item)
        {
            ...
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    command.CommandText = "INSERT INTO `items` (`hash`, `ownerEntity`, `ownerIdentifier`, `amount`, `posX`, `posY`, `posZ`, `quality`)";
                    command.CommandText += " VALUES (@hash, @ownerEntity, @ownerIdentifier, @amount, @posX, @posY, @posZ, @quality)";
        ...
        public static void UpdateItem(ItemModel item)
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    command.CommandText += "`posX` = @posX, `posY` = @posY, `posZ` = @posZ, `dimension` = @dimension, `quality` = @quality WHERE `id` = @id LIMIT 1";
                    command.Parameters.AddWithValue("@ownerEntity", item.ownerEntity);
                    command.Parameters.AddWithValue("@ownerIdentifier", item.ownerIdentifier);
                    command.Parameters.AddWithValue("@amount", item.amount);
                    command.Parameters.AddWithValue("@posX", item.position.X);
        ...
        public static void DeleteSingleRow(int id)
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    command.CommandText = "DELETE FROM plants WHERE id = @id LIMIT 1";
                    command.Parameters.AddWithValue("@id", id);
            ...
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                ...
                using (MySqlDataReader reader = command.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        business.price = reader.GetInt32("price");
        ...
        public static void UpdateBusiness(BusinessModel business)
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    command.Parameters.AddWithValue("@price", business.price);
