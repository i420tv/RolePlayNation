...
namespace WiredPlayers.character
{
    ...
    {     
            ...
            Task.Factory.StartNew(() =>
            {
                NAPI.Task.Run(() =>
                {
                    ...
                    if (playerId > 0)
                    {
                        ...
                        player.SetData(EntityData.PLAYER_SPAWN_POS, new Vector3(305.6136f, -1204.167f, 38.89258f));
        ...
        public void SetCharacterIntoCreatorEvent(Client player)
        {
            ...
            player.Transparency = 255;
            player.Rotation = new Vector3(0.0f, 0.0f, 260.0f);
            player.Position = new Vector3(-2088.9587, -1016.64075, 8.971191);
